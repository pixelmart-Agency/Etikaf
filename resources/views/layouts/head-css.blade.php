...
<link rel="stylesheet" type="text/css" href="{{ assetUrl('css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ assetUrl('css/select2.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ assetUrl('css/bootstrap-datetimepicker.min.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ assetUrl('css_v2/validationEngine.jquery-rtl.css') }}">
<style>
    .password-container button#toggle-password,
    .password-container button#toggle-password-confirm,
    .password-container button#toggle-confirm-password {
        top: 70% !important;
    }
</style>
