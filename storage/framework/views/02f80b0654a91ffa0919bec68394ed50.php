...
<div class="d-flex gap-3 flex-wrap mt-3">
    <fieldset class="flex-grow-1">
        ...
        <?php if($single && ($single->image_url || $single->avatar_url)): ?>
            <div class="text-start mt-2">
                <img id="image-preview" src="<?php echo e(imageUrl($single->image_url ?? $single->avatar_url)); ?>"
...
<?php /**PATH C:\Users\mahmo\Herd\eatikaf\resources\views/components/image.blade.php ENDPATH**/ ?>