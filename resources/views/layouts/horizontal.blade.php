            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    @switch(Session::get('lang'))
                        @case('ru')
                            <img src="{{ URL::asset('public/build/images/flags/russia.jpg') }}" alt="Header Language"
                                height="16"> <span class="align-middle">Russian</span>
                        @break

                        @case('it')
                            <img src="{{ URL::asset('public/build/images/flags/italy.jpg') }}" alt="Header Language"
                                height="16"> <span class="align-middle">Italian</span>
                        @break

                        @case('de')
                            <img src="{{ URL::asset('public/build/images/flags/germany.jpg') }}" alt="Header Language"
                                height="16"> <span class="align-middle">German</span>
                        @break

                        @case('es')
                            <img src="{{ URL::asset('public/build/images/flags/spain.jpg') }}" alt="Header Language"
                                height="16"> <span class="align-middle">Spanish</span>
                        @break

                        @default
                            <img src="{{ URL::asset('public/build/images/flags/us.jpg') }}" alt="Header Language"
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <a href="ui-modals" class="dropdown-item"
                                            key="t-modals">@lang('translation.Modals')</a>
                                        <a href="ui-offcanvas" class="dropdown-item"
                                            key="t-offcanvas">@lang('translation.Offcanvas')</a>
                                        ...
                                        <a href="ui-session-timeout" class="dropdown-item"
                                            key="t-session-timeout">@lang('translation.Session_Timeout')</a>
                                        <a href="ui-progressbars" class="dropdown-item"
                                            key="t-progress-bars">@lang('translation.Progress_Bars')</a>
                                        <a href="ui-placeholders" class="dropdown-item"
                                            key="t-placeholders">@lang('translation.Placeholders')</a>
                                        ...
                                        <a href="ui-tabs-accordions" class="dropdown-item"
                                            key="t-tabs-accordions">@lang('translation.Tabs_&_Accordions')</a>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <a href="ui-colors" class="dropdown-item"
                                            key="t-colors">@lang('translation.Colors')</a>
                                        <a href="ui-rating" class="dropdown-item"
                                            key="t-rating">@lang('translation.Rating')</a>
                                        <a href="ui-notifications" class="dropdown-item"
                                            key="t-notifications">@lang('translation.Notifications')</a>
                                        <a href="ui-utilities" class="dropdown-item"
                                            key="t-utilities">@lang('translation.Utilities')</a>
                                    </div>
                                </div>
                            </div>
