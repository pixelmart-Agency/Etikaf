...
<script src="<?php echo e(assetUrl('js/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/dataTables.bootstrap4.min.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/select2.min.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/jquery.slimscroll.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/moment.min.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/bootstrap-datetimepicker.min.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/bootstrap-datepicker.ar.min.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/app.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/mahmoud.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/validationEngine/jquery.validationEngine.js')); ?>"></script>
<script src="<?php echo e(assetUrl('js/validationEngine/languages/jquery.validationEngine-ar.js')); ?>"></script>
...
<script>
    function markAsRead(id) {
        $.ajax({
            url: '<?php echo e(route('notifications.mark-as-read')); ?>',
            method: 'POST',
            data: {
                id: id,
...
<?php if(!route_is('notifications.index')): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\mahmo\Herd\eatikaf\resources\views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>