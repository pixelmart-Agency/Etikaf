...
<head>
    ...
    <title>{{ getSetting('app_name_ar') }} | الرئيسية</title>
    <link href="{{ assetUrl('css/global.css', 'landing-assets') }}" rel="stylesheet" type="text/css">
...
<body class="rtl">
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                <div class="logo"><a href="#">
                        <img style=" width: 105px; height: 56px;" src="{{ getSettingMedia('app_logo') }}"
                            alt="logo" /></a>
                </div>
                <nav class="nav-bar">
                    <ul>
                ...
                <a href="{{ route('login') }}" class="cus-btn">الدخول كموظف</a>
            </div>
        </div>
    </header>
    <!-------------Banner---------->
    <main>
                ...
                <div class="row flex-row-reverse align-items-center">
                    <div class="col-md-6" data-aos="fade-right">
                        <div class="banner-img">
                            <img src="{{ assetUrl('images/banner.png', 'landing-assets') }}" alt="" />
                        </div>
                    </div>
                    <div class="col-md-6" data-aos="fade-left">
                        ...
                        <a href="#" class="com-ntn"><img src="{{ assetUrl('images/code.svg', 'landing-assets') }}"
                                alt="" />
                            حمّل
                            التطبيق</a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4" data-aos="flip-left">
                        <div class="col-box">
                            <img src="{{ assetUrl('images/icon-1.svg', 'landing-assets') }}" alt="" />
                            <h3>توفير مواد العبادة</h3>
                            <p>نسخ من المصاحف، كتيبات أدعية، وسجاد للصلاة.</p>
                            <span class="bx-bg"><img src="{{ assetUrl('images/card-bg.svg', 'landing-assets') }}"
                                    alt="" /></span>
                        </div>
                    </div>
                    <div class="col-md-4" data-aos="flip-left">
                        <div class="col-box">
                            <img src="{{ assetUrl('images/icon-2.svg', 'landing-assets') }}" alt="" />
                    ...
                    <div class="col-md-4" data-aos="flip-left">
                        <div class="col-box">
                            <img src="{{ assetUrl('images/icon-3.svg', 'landing-assets') }}" alt="" />
        ...
        <section class="sec bg-light" id="steps">
            <div class="container">
                <div class="row flex-row-reverse align-items-center">
                    <div class="col-md-6" data-aos="fade-right">
                        <img src="{{ assetUrl('images/login-img.jpg', 'landing-assets') }}" alt="" />
                    </div>
                    <div class="col-md-6" data-aos="fade-left">
                        <div class="sec-con">
                ...
                <div class="row align-items-center mt-5">
                    <div class="col-md-6" data-aos="fade-left">
                        <img src="{{ assetUrl('images/main-img.jpg', 'landing-assets') }}" alt="">
                    </div>
                    <div class="col-md-6" data-aos="fade-right">
                        <div class="sec-con">
                ...
                <div class="row flex-row-reverse align-items-center mt-5">
                    <div class="col-md-6" data-aos="fade-right">
                        <img src="{{ assetUrl('images/send-request-img.jpg', 'landing-assets') }}" alt="" />
                    </div>
                    <div class="col-md-6" data-aos="fade-left">
                        <div class="sec-con">
    ...
    <footer class="footer">
        <div class="container">
            <div class="d-flex align-items-center flex-wrap justify-content-between">
                <div class="logo"><a href="#"><img src="{{ getSettingMedia('app_logo') }}"
    ...
    <script src="{{ assetUrl('js/popper.min.js', 'landing-assets') }}"></script>
    <script src="{{ assetUrl('js/bootstrap.min.js', 'landing-assets') }}"></script>
