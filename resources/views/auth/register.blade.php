...
@section('css')
    ...
    <link href="{{ URL::asset('public/build/libs/bootstrap-datepicker/bootstrap-datepicker.min.css') }}" rel="stylesheet"
        type="text/css">
@endsection
...
@section('body')
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ URL::asset('public/build/images/logo-dark.png') }}" alt=""
                                                height="18" class="auth-logo-dark">
                                            <img src="{{ URL::asset('public/build/images/logo-light.png') }}" alt=""
    ...
    @endsection
    @section('script')
        <script src="{{ URL::asset('public/build/libs/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
        <!-- owl.carousel js -->
